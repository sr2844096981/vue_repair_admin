    ...
    <el-card shadow="never">
      <el-form ref="formQRinfo" label-width="80px">
        ...
        <el-form-item label="设备编号">
          <el-input v-model="formQRinfo.deviceId" :disabled="status=='update'?true:false"></el-input>
        </el-form-item>
        ...
        <el-form-item>
          <el-button
            type="primary"
            v-if="formQRinfo.deviceId !== ''"
            @click="updateDeviceInfo"
            >修改二维码</el-button
          >
          <el-button type="primary" v-else @click="onEstablish"
            >创建二维码</el-button
          >
